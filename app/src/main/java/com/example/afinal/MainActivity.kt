...
fun UiWindow(
    ...
    Scaffold(
        ...
        bottomBar = {
            BottomAppBar {
                NavigationBarItem(selected = true, onClick = {navController.navigate("screen1")  }, icon = { Icon(
                    imageVector = Icons.Default.CommentBank,
                    contentDescription = "Ask"
                )})
                NavigationBarItem(selected = true, onClick = { navController.navigate("screen2")}, icon = { Icon(
                    imageVector = Icons.AutoMirrored.Filled.DirectionsRun,
                    contentDescription = "Ask"
                )})
                NavigationBarItem(selected = true, onClick = { navController.navigate("screen3") }, icon = { Icon(
...
private suspend fun postDataUsingRetrofit(
    ...
    val url = "http://192.168.29.145:3000"
